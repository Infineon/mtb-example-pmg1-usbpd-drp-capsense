 ...
 */
#define CAPSENSE_SLOW_TIMER_ID                  (CY_PDUTILS_TIMER_USER_START_ID + 2u)
#define CAPSENSE_FAST_TIMER_ID                  (CY_PDUTILS_TIMER_USER_START_ID + 3u)
...
/**
 * @typedef en_source_pdo_mask_t
 * @brief Types of Source PDO Mask
 */
typedef enum
{
    FIXED_5V = 0x1,
    FIXED_9V_AND_FIXED_5V = 0x3,
    FIXED_12V_AND_FIXED_5V = 0x5,
    FIXED_15V_AND_FIXED_5V = 0x9,
    FIXED_20V_AND_FIXED_5V = 0x11
}en_source_pdo_mask_t;
